...
rewrite the full METAR code string properly formatted according hte the official rules. It will be compared and scored,
...
directionDict = {'NNE': [12, 33],
                 ...
                 'NW': [304, 326],
                 'NNW': [327, 348]}
hintList = ['At least 3.', 'No thank you.', 'You are failiure', '(Disappointment)', 'Remember: Order matters.',
            'Celcius, miles per hour, and inches are the units used in the codes.',
